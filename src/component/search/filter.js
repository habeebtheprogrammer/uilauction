    ...
    filter(){
        ...
        // this.setState({ searching: true })
         window.location.search ===""?
             axios.get(`${apiUrl}/api/filter?orderby=${this.state.orderby}&distance=${this.state.distance}&category=${this.state.category}`).then((res) => {
                 if (res.data.search) {
        ...
        :
        axios.get(`${apiUrl}/api/search${window.location.search}&orderby=${this.state.orderby}&distance=${this.state.distance}&category=${this.state.category}`).then((res) => {
            if (res.data.search) {
