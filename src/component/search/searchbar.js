...
class Searchbar extends Component {
    ...
    render() {
        return (
            <div>
            <form className="search hide-on-med-and-down" action={`/search?name=${this.state.name}&location=${this.state.location}`}>
            ...
            <form className="search hide-on-med-and-up" action={`/search?name=${this.state.name}&location=${this.state.location}`}>
                <div style={{ padding: "10px 0px 0px" }}>
                    <div className="row" style={{ marginBottom: "0px" }}>
