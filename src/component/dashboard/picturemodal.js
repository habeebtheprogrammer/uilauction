            ...
            <div className="pmodal">
                            ...
                            <form onSubmit={this.submitform}>
                                <Row >
                                    <FileUpload options={{
                                        ...
                                        paramAddToField: { token: token, caption: this.state.caption, description: this.state.description }
                                    }}>

                                        <Row>
                                            <Col s={12}>
                                                <label>Caption  <span className="red-text">*</span> {this.state.error.caption ? <span className="red-text">This field is required</span> : null}</label>
                                                <input name="caption" onChange={this.typing} type="text" className="input" required="required" title="" />
                                            </Col>
                                        ...
                                        {/* <Input s={12} className="grey-text darken-1 no-pad" labelClassName="grey-text darken-1" name="caption" label="Caption" onChange={this.typing} error={this.state.error.caption ? ' ' : null} type="text" validate></Input> */}
                                        ...
                                        <button ref="uploadBtn" className="btn red z-depth-0 lighten-1" disabled={this.state.fileName !== "" ? false : true} style={{ width: "100%", fontSize: "0.8em" }}>
                                            {this.state.progress !== "" ? <span> <Loading /> Loading</span> : "Continue"}
                                        </button>
                                    </FileUpload>
                                </Row>
                            </form>
                ...
                <style>{`
                    ...
                    .row{
                        ...
                        .pbg1{
                     background:linear-gradient(rgba(0,0,0,0.1),rgba(0,0,0,0.1)),#263238 url('../../../images/logo_TamTamTools_zwart.jpg') no-repeat;
