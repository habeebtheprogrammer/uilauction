            ...
            : 
                ...
                <Modal open={this.state.open} onClose={this.onCloseModal} classNames={{ modal: "custom-modal" }} little>
                    <div className="row pbg1">
                        ...
                        <div className="col m7  white" style={{ padding: "30px" }}>
                            <form onSubmit={this.submitform}>
                                <Row >
                                    <FileUpload options={{
                                        ...
                                        paramAddToField: { token: token, title: this.state.title, description: this.state.description }
                                    }}>
                                        ...
                                        <Row>
                                            <Col s={12}>
                                                ...
                                                <input name="title" onChange={this.typing} type="text" className="input" required="required" title="" />
                                            </Col>
                                        ...
                                        {/* <Input s={12} className="grey-text darken-1 no-pad" labelClassName="grey-text darken-1" name="title" label="title" onChange={this.typing} error={this.state.error.title ? ' ' : null} type="text" validate></Input> */}
