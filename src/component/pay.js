...
class Paypal extends React.Component {
    ...
    render() {
        const onSuccess = (payment) => {
            ...
            axios.post(`${apiUrl}/api/payment_successful`, { token }).then((res) => {
                if (res.data.success) {
        ...
        var amount; 
        if (this.props.data.membership === "artist" && this.props.data.completed) amount = 78;
        if (this.props.data.membership === "supporters" && this.props.data.completed) amount = 48
        let total = amount;
